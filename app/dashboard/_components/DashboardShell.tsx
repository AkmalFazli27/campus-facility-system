...
import MobileDrawer from "@/app/dashboard/_components/MobileDrawer";
import MobileTopBar from "@/app/dashboard/_components/MobileTopBar";
...
export default function DashboardShell({
  ...
  return (
    <div className={cn("w-full transition-[padding] duration-200", collapsed ? "lg:pl-[72px]" : "lg:pl-[250px]")}>
      ...
      <MobileDrawer open={drawerOpen} onClose={closeDrawer} role={role} user={user} />
    </div>
  );
}
