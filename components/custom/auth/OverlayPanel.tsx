  ...
  return (
    <div className="overlay-container pointer-events-none absolute top-0 left-1/2 hidden h-full w-1/2 overflow-hidden md:block">
      <div className="overlay relative -left-full h-full w-[200%] bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 text-white">
        ...
        />
        <div className="overlay-panel overlay-left absolute top-0 left-0 flex h-full w-1/2 flex-col items-center justify-center p-16 text-center select-none">
          <span className="mb-6 flex h-[72px] w-[72px] items-center justify-center rounded-2xl border border-white/20 bg-white/15 shadow-inner backdrop-blur-md">
            <LockOpen aria-hidden className="size-9" />
          </span>
          <h2 className="mb-3 text-4xl leading-tight font-semibold">
          ...
          <button
            ...
            className="pointer-events-auto flex items-center gap-2 rounded-full border-2 border-white/90 px-10 py-3.5 text-base font-semibold tracking-wide uppercase transition-all duration-300 hover:bg-white hover:text-brand-700 active:scale-95"
          >
            <ArrowLeft aria-hidden className="size-4" />
            <span>Masuk ke portal</span>
          </button>
        </div>
        <div className="overlay-panel overlay-right absolute top-0 right-0 flex h-full w-1/2 flex-col items-center justify-center p-16 text-center select-none">
          <span className="mb-6 flex h-[72px] w-[72px] items-center justify-center rounded-2xl border border-white/20 bg-white/15 shadow-inner backdrop-blur-md">
            <GraduationCap aria-hidden className="size-9" />
          </span>
          <h2 className="mb-3 text-4xl leading-tight font-semibold">
