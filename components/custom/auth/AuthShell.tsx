    ...
    <main className="relative flex w-full flex-1 flex-col items-center justify-center px-4 py-8 sm:px-6">
      ...
      <div className="flex w-full max-w-[940px] flex-col gap-4">
        <Link
          ...
          className="inline-flex min-h-11 w-fit items-center gap-1.5 text-sm font-semibold text-ink-600 hover:text-brand-600 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:outline-none"
        >
          <ArrowLeft aria-hidden className="size-4" />
          <span>Kembali ke beranda</span>
        </Link>
        <div
          className={`auth-slider relative flex w-full flex-col overflow-hidden rounded-3xl border bg-surface shadow-xl shadow-brand-100/60 md:block md:min-h-[640px] ${
